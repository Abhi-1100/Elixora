...
export default function ReportDetailPage() {
  ...
  if (authLoading || loading) {
    return (
      <div className="min-h-screen bg-[var(--bg)] text-[var(--ink)] flex flex-col transition-colors duration-200">
        <Navbar />
        <main className="flex-1 max-w-5xl mx-auto w-full px-6 py-10 space-y-6 animate-fade-in">
          <div className="flex items-center justify-between">
            <div className="h-6 skeleton-shimmer rounded-lg w-32" />
            <div className="h-8 skeleton-shimmer rounded-xl w-40" />
          </div>
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            <div className="h-96 skeleton-shimmer rounded-3xl lg:col-span-1" />
            <div className="space-y-4 lg:col-span-2">
              <div className="h-10 skeleton-shimmer rounded-2xl w-full" />
  ...
  if (error) {
    return (
      <div className="min-h-screen bg-[var(--bg)] text-[var(--ink)] flex flex-col transition-colors duration-200">
        <Navbar />
        <main className="flex-1 max-w-2xl mx-auto w-full px-6 py-12 text-center animate-fade-in">
          <div className="p-8 rounded-3xl bg-[var(--surface)] border border-[var(--border)] space-y-4">
            ...
            <h2 className="text-xl font-semibold text-[var(--ink)]">{error}</h2>
            <Link
              href="/reports"
              className="inline-flex items-center gap-2 text-xs font-semibold px-4 py-2.5 rounded-xl bg-[var(--accent)] text-white hover:opacity-90 active:scale-[0.98] transition-all focus-ring"
            >
