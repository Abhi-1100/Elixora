...
export function EmptyState({ onSelectPrompt, InputBarComponent }: EmptyStateProps) {
  return (
    <div className="flex-1 flex flex-col items-center justify-center p-6 text-center max-w-3xl w-full mx-auto my-auto select-none gap-8">
      ...
      <div className="flex items-center justify-center gap-3">
        ...
        <h2 className="font-display text-4xl sm:text-5xl font-medium tracking-tight text-[var(--ink)]">
          Hey there, abhi
        </h2>
      </div>
